...
This is the Roblox Plugin side of RoRender V4. The code here is responsible for 4 things.

1. Plugin UI and configuration deployment
2. Raytracing and gathering suplimental data for the editor 
3. Compressing data
...
thoughrouly before being accepted.
